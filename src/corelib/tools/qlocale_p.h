...
public:
    ...
    double stringToDouble(QStringView str, bool *ok, int *endpos,
                          QLocale::NumberOptions options) const;
    qint64 stringToLongLong(QStringView str, int base, bool *ok, int *endpos,
                            QLocale::NumberOptions options) const;
    quint64 stringToUnsLongLong(QStringView str, int base, bool *ok, int *endpos,
                                QLocale::NumberOptions options) const;
    ...
    Q_CORE_EXPORT static quint64 bytearrayToUnsLongLong(const char *num, int base,
                                                        bool *ok = nullptr, int *endpos = nullptr);
