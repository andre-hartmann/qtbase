...
void tst_QByteArray::toInt_data()
{
    ...
    QTest::newRow("whitespace2") << QByteArray("100    ") << 10 << 100 << true << 3;
    QTest::newRow("whitespace3") << QByteArray("  100  ") << 10 << 100 << true << 5;

    QTest::newRow("leading space") << QByteArray(" 100") << 10 << int(100) << true << 4;
    QTest::newRow("trailing space") << QByteArray("100 ") << 10 << int(100) << true << 3;
