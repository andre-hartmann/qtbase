...
#define TEST_TO_INT(num, func) \
    ...
    QVERIFY2(a.func(&ok, &convertedChars) == num ## i64 && ok && convertedChars == strlen(#num), "Failed: num=" #num ", func=" #func);
#else
#define TEST_TO_INT(num, func) \
    a = #num; \
    QVERIFY2(a.func(&ok) == num ## LL && ok, "Failed: num=" #num ", func=" #func); \
    QVERIFY2(a.func(&ok, 10, &convertedChars) == num ## LL && ok && convertedChars == strlen(#num), "Failed: num=" #num ", func=" #func);
#endif
...
#define TEST_TO_UINT(num, func) \
    a = #num; \
    QVERIFY2(a.func(&ok) == num ## i64 && ok, "Failed: num=" #num ", func=" #func); \
    QVERIFY2(a.func(&ok, 10, &convertedChars) == num ## i64 && ok && convertedChars == strlen(#num), "Failed: num=" #num ", func=" #func);
#else
#define TEST_TO_UINT(num, func) \
    a = #num; \
    QVERIFY2(a.func(&ok) == num ## ULL && ok, "Failed: num=" #num ", func=" #func); \
    QVERIFY2(a.func(&ok, 10, &convertedChars) == num ## ULL && ok && convertedChars == strlen(#num), "Failed: num=" #num ", func=" #func);
#endif
...
#define TEST_BASE(str, base, num) \
    ...
    QVERIFY2(a.toInt(&ok, base, &convertedChars) == num && ok && convertedChars == rtrimlen(str), "Failed: str=" #str " base= "#base " num=" #num ", func=toInt"); \
    QVERIFY2(a.toUInt(&ok, base, &convertedChars) == num && ok && convertedChars == rtrimlen(str), "Failed: str=" #str " base= "#base " num=" #num ", func=toUInt"); \
    QVERIFY2(a.toShort(&ok, base, &convertedChars) == num && ok && convertedChars == rtrimlen(str), "Failed: str=" #str " base= "#base " num=" #num ", func=toShort"); \
    QVERIFY2(a.toUShort(&ok, base, &convertedChars) == num && ok && convertedChars == rtrimlen(str), "Failed: str=" #str " base= "#base " num=" #num ", func=toUShort"); \
    QVERIFY2(a.toLong(&ok, base, &convertedChars) == num && ok && convertedChars == rtrimlen(str), "Failed: str=" #str " base= "#base " num=" #num ", func=toLong"); \
    QVERIFY2(a.toULong(&ok, base, &convertedChars) == num && ok && convertedChars == rtrimlen(str), "Failed: str=" #str " base= "#base " num=" #num ", func=toULong"); \
    QVERIFY2(a.toLongLong(&ok, base, &convertedChars) == num && ok && convertedChars == rtrimlen(str), "Failed: str=" #str " base= "#base " num=" #num ", func=toLongLong"); \
    QVERIFY2(a.toULongLong(&ok, base, &convertedChars) == num && ok && convertedChars == rtrimlen(str), "Failed: str=" #str " base= "#base " num=" #num ", func=toULongLong");
...
#define TEST_DOUBLE(num, str) \
    ...
    QVERIFY(ok); \
    QCOMPARE(a.toDouble(&ok, &convertedChars), num); \
    QVERIFY(ok); \
    QCOMPARE(convertedChars, rtrimlen(str));
...
#define TEST_BAD(str, func) \
    ...
    a.func(&ok, 10, &convertedChars); \
    QVERIFY2(!ok && convertedChars == 0, "Failed: str=" #str " func=" #func);
...
#define TEST_BAD_ALL(str) \
    ...
    a.toDouble(&ok); \
    QVERIFY2(!ok, "Failed: str=" #str); \
    a.toShort(&ok, 10, &convertedChars); \
    QVERIFY2(!ok && convertedChars == 0, "Failed: str=" #str); \
    a.toUShort(&ok, 10, &convertedChars); \
    QVERIFY2(!ok && convertedChars == 0, "Failed: str=" #str); \
    a.toInt(&ok, 10, &convertedChars); \
    QVERIFY2(!ok && convertedChars == 0, "Failed: str=" #str); \
    a.toUInt(&ok, 10, &convertedChars); \
    QVERIFY2(!ok && convertedChars == 0, "Failed: str=" #str); \
    a.toLong(&ok, 10, &convertedChars); \
    QVERIFY2(!ok && convertedChars == 0, "Failed: str=" #str); \
    a.toULong(&ok, 10, &convertedChars); \
    QVERIFY2(!ok && convertedChars == 0, "Failed: str=" #str); \
    a.toLongLong(&ok, 10, &convertedChars); \
    QVERIFY2(!ok && convertedChars == 0, "Failed: str=" #str); \
    a.toULongLong(&ok, 10, &convertedChars); \
    QVERIFY2(!ok && convertedChars == 0, "Failed: str=" #str); \
    a.toFloat(&ok, &convertedChars); \
    QVERIFY2(!ok && convertedChars == 0, "Failed: str=" #str); \
    a.toDouble(&ok, &convertedChars); \
    QVERIFY2(!ok && convertedChars == 0, "Failed: str=" #str);
...
#define TEST_SHORT(str, intvalue, floatvalue) \
    ...
    a.toDouble(&ok); \
    QVERIFY2(!ok, "Failed: str=" #str); \
    QVERIFY(a.toShort(&ok, 10, &convertedChars) == intvalue); \
    QVERIFY2(ok, "Failed: str=" #str); \
    QCOMPARE(size_t(convertedChars), strlen(#intvalue)); \
    QVERIFY(a.toUShort(&ok, 10, &convertedChars) == intvalue); \
    QVERIFY2(ok, "Failed: str=" #str); \
    QCOMPARE(size_t(convertedChars), strlen(#intvalue)); \
    QVERIFY(a.toInt(&ok, 10, &convertedChars) == intvalue); \
    QVERIFY2(ok, "Failed: str=" #str); \
    QCOMPARE(size_t(convertedChars), strlen(#intvalue)); \
    QVERIFY(a.toUInt(&ok, 10, &convertedChars) == intvalue); \
    QVERIFY2(ok, "Failed: str=" #str); \
    QCOMPARE(size_t(convertedChars), strlen(#intvalue)); \
    QVERIFY(a.toLong(&ok, 10, &convertedChars) == intvalue); \
    QVERIFY2(ok, "Failed: str=" #str); \
    QCOMPARE(size_t(convertedChars), strlen(#intvalue)); \
    QVERIFY(a.toULong(&ok, 10, &convertedChars) == intvalue); \
    QVERIFY2(ok, "Failed: str=" #str); \
    QCOMPARE(size_t(convertedChars), strlen(#intvalue)); \
    QVERIFY(a.toLongLong(&ok, 10, &convertedChars) == intvalue); \
    QVERIFY2(ok, "Failed: str=" #str); \
    QCOMPARE(size_t(convertedChars), strlen(#intvalue)); \
    QVERIFY(a.toULongLong(&ok, 10, &convertedChars) == intvalue); \
    QVERIFY2(ok, "Failed: str=" #str); \
    QCOMPARE(size_t(convertedChars), strlen(#intvalue)); \
    QVERIFY(qFuzzyCompare(a.toFloat(&ok, &convertedChars), float(floatvalue))); \
    QVERIFY2(ok, "Failed: str=" #str); \
    QCOMPARE(size_t(convertedChars), strlen(#floatvalue)); \
    QVERIFY(qFuzzyCompare(a.toDouble(&ok, &convertedChars), floatvalue)); \
    QVERIFY2(ok, "Failed: str=" #str); \
    QCOMPARE(size_t(convertedChars), strlen(#floatvalue));
...
void tst_QString::toUShort()
{
    ...
    QVERIFY(!ok);
    QCOMPARE(a.toUShort(&ok, 10, &convertedChars), ushort(0));
    QVERIFY(!ok);
    QCOMPARE(convertedChars, 0);
    ...
    QVERIFY(ok);
    QCOMPARE(a.toUShort(&ok, 10, &convertedChars), ushort(123));
    QVERIFY(ok);
    QCOMPARE(convertedChars, 3);
    ...
    QVERIFY(ok);
    QCOMPARE(a.toUShort(&ok, 10, &convertedChars), ushort(32767));
    QVERIFY(ok);
    QCOMPARE(convertedChars, 5);
    ...
    QVERIFY(ok);
    QCOMPARE(a.toUShort(&ok, 10, &convertedChars), ushort(65535));
    QVERIFY(ok);
    QCOMPARE(convertedChars, 5);
...
void tst_QString::toShort()
{
    ...
    QVERIFY(!ok);
    QCOMPARE(a.toShort(&ok, 10, &convertedChars), short(0));
    QVERIFY(!ok);
    QCOMPARE(convertedChars, 0);
    ...
    QVERIFY(ok);
    QCOMPARE(a.toShort(&ok, 10, &convertedChars), short(123));
    QVERIFY(ok);
    QCOMPARE(convertedChars, 3);
    ...
    QVERIFY(ok);
    QCOMPARE(a.toShort(&ok, 10, &convertedChars), short(32767));
    QVERIFY(ok);
    QCOMPARE(convertedChars, 5);
    ...
    QCOMPARE(a.toShort(&ok, 10, &convertedChars), short(-32767));
    QVERIFY(ok);
    QCOMPARE(convertedChars, 6);

    a = "-32768";
    QCOMPARE(a.toShort(),(short)-32768);
    QCOMPARE(a.toShort(&ok),(short)-32768);
    QVERIFY(ok);
    QCOMPARE(a.toShort(&ok, 10, &convertedChars), short(-32768));
    QVERIFY(ok);
    QCOMPARE(convertedChars, 6);
...
void tst_QString::toInt()
{
    ...
    QVERIFY(!ok);
    QCOMPARE(a.toInt(&ok, 10, &convertedChars), 0);
    QVERIFY(!ok);
    QCOMPARE(convertedChars, 0);
    ...
    QVERIFY(ok);
    QCOMPARE(a.toInt(&ok, 10, &convertedChars), 123);
    QVERIFY(ok);
    QCOMPARE(convertedChars, 3);
    ...
    QVERIFY(ok);
    QCOMPARE(a.toInt(&ok, 10, &convertedChars), 1234567);
    QVERIFY(ok);
    QCOMPARE(convertedChars, 7);
    ...
    QCOMPARE(a.toInt(&ok),0);
    QVERIFY(!ok);
    QCOMPARE(a.toInt(&ok, 10, &convertedChars),12345);
    QVERIFY(ok);
    QCOMPARE(convertedChars, 5);
    ...
    QVERIFY(ok);
    QCOMPARE(a.toInt(&ok, 10, &convertedChars), 2147483647);
    QVERIFY(ok);
    QCOMPARE(convertedChars, 10);
    ...
    if (sizeof(int) == 4) {
        ...
        QVERIFY(ok);
        QCOMPARE(a.toInt(&ok, 10, &convertedChars), -2147483647 - 1);
        QVERIFY(ok);
        QCOMPARE(convertedChars, 11);
...
void tst_QString::toUInt()
{
    ...
    QVERIFY(ok);
    QCOMPARE(a.toUInt(&ok, 10, &convertedChars), 3234567890u);
    QVERIFY(ok);
    QCOMPARE(convertedChars, 10);
    ...
    QVERIFY(!ok);
    QCOMPARE(a.toUInt(&ok, 10, &convertedChars), 0u);
    QVERIFY(!ok);
    QCOMPARE(convertedChars, 0);
    ...
    QVERIFY(ok);
    QCOMPARE(a.toUInt(&ok, 10, &convertedChars), 4294967295u);
    QVERIFY(ok);
    QCOMPARE(convertedChars, 10);
...
void tst_QString::toULong()
{
    ...
    QCOMPARE(b, ok);
    QCOMPARE(convertedChars, str.length());
}
...
void tst_QString::toLong()
{
    ...
    int convertedChars;
    QCOMPARE(str.toLong(&b, base, &convertedChars), result);
    QCOMPARE(b, ok);
    QCOMPARE(convertedChars, str.length());
}
...
void tst_QString::toULongLong()
{
    ...
    QVERIFY( ok );
    QCOMPARE(str.toULongLong(&ok, 10, &convertedChars), Q_UINT64_C(18446744073709551615));
    QVERIFY(ok);
    QCOMPARE(convertedChars, 20);

    str = "18446744073709551616"; // ULLONG_MAX + 1
    QCOMPARE( str.toULongLong( 0 ), Q_UINT64_C(0) );
    QCOMPARE( str.toULongLong( &ok ), Q_UINT64_C(0) );
    QVERIFY( !ok );
    QCOMPARE(str.toULongLong(&ok, 10, &convertedChars), Q_UINT64_C(0));
    QVERIFY(!ok);
    QCOMPARE(convertedChars, 0);
...
void tst_QString::toLongLong()
{
    ...
    QVERIFY( ok );
    QCOMPARE(str.toLongLong(&ok, 10, &convertedChars), Q_INT64_C(9223372036854775807));
    QVERIFY(ok);
    QCOMPARE(convertedChars, 19);
    ...
    QCOMPARE( str.toLongLong( &ok ),
             -Q_INT64_C(9223372036854775807) - Q_INT64_C(1) );
    QVERIFY( ok );
    QCOMPARE(str.toLongLong(&ok, 10, &convertedChars),
             -Q_INT64_C(9223372036854775807) - Q_INT64_C(1));
    QVERIFY(ok);
    QCOMPARE(convertedChars, 20);
    ...
    QVERIFY( !ok );
    QCOMPARE(str.toLongLong(&ok, 10, &convertedChars), Q_INT64_C(0));
    QVERIFY(!ok);
    QCOMPARE(convertedChars, 0);
...
void tst_QString::toFloat()
{
    ...
    int convertedChars;
    QCOMPARE(a.toFloat(&ok, &convertedChars), 0.000000000931322574615478515625f);
    QVERIFY(ok);
    QCOMPARE(convertedChars, a.length());
}
...
void tst_QString::toDouble_data()
{
    ...
    QTest::newRow("ok00") << QString("0.000000000931322574615478515625")
                          << 0.000000000931322574615478515625 << true << 32;
    ...
    QTest::newRow("ok12") << QString("100,") << 100.0 << false << 3;

    double inf = std::numeric_limits<double>::infinity();

    QTest::newRow("+double-max") << QString("+1.7976931348623157E308")
                                << +1.7976931348623157E308 << false << 23;
    QTest::newRow("+double-max-exceed") << QString("+1.7976931348623159E308")
                                        << +inf << false << 23;
    QTest::newRow("+double-exp-exceed") << QString("+1.7976931348623157E999")
                                << +inf << true << 23;

    QTest::newRow("+double-min") << QString("+4.9E-324")
                                 << +4.9E-324 << true << 9;
    QTest::newRow("-double-max") << QString("-1.7976931348623157E308")
                                 << -1.7976931348623157E308 << true << 23;
    QTest::newRow("-double-min") << QString("-4.9E-324")
                                 << -4.9E-324 << true << 9;

    QTest::newRow("trailing-whitespace") << QString("123.45 ") << 123.45 << true << 6;
    QTest::newRow("surrounding-whitespace") << QString(" 123.45 ") << 123.45 << true << 7;
    QTest::newRow("leading-whitespace") << QString(" 123.45") << 123.45 << true << 7;

    QTest::newRow("leading-letters") << QString("aa123.45") << 0.0 << false << 0;
    QTest::newRow("surrounding-letters") << QString("aa123.45aa") << 0.0 << false << 0;
    QTest::newRow("trailing-letters") << QString("123.45aa") << 123.45 << false << 6;
    QTest::newRow("trailing-dot") << QString("100.1.") << 100.1 << false << 5;

    QTest::newRow("trailing-e") << QString("100e") << 100.0 << false << 3; // fails: convertedChars == 4
    QTest::newRow("trailing-e-after-exponent") << QString("100e1e") << 1000.0 << false << 5;
    QTest::newRow("trailing-erf") << QString("123erf") << 123.0 << false << 3;

    QTest::newRow("no digits") << QString("abc") << 0.0 << false << 0;
    QTest::newRow("null") << QString() << 0.0 << false << 0;
    QTest::newRow("empty") << QString("") << 0.0 << false << 0;
}
...
void tst_QString::toDouble()
{
    ...
    int convertedChars;
    d = str.toDouble(&ok, &convertedChars);
    QCOMPARE(convertedChars, result_endpos);
...
void tst_QString::nanAndInf_data()
{
    ...
    // when parsing with convertedChars, some of the options below change meaning
...
#undef CHECK_NAN
    ...
    d = text.toDouble(&ok, &convertedChars);
    QCOMPARE(convertedChars, expected_endpos);
    QCOMPARE(ok, convertedChars != 0);
    if (ok && d) {
    ...
    f = text.toFloat(&ok, &convertedChars);
    QCOMPARE(convertedChars, expected_endpos);
    QCOMPARE(ok, convertedChars != 0);
    if (ok && f) {
        if (qIsNaN(expected_value_endpos))
